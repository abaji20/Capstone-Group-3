...
const SuperAdminSidebar = ({ mobileOpen, handleDrawerToggle, isMini, handleToggleMini }) => {
  ...
  const drawerContent = (
    <Box sx={{ 
      ...
      {/* TOGGLE SECTION: Fixed height to prevent overflow */}
      <Box sx={{ 
        display: 'flex', 
      ...
      {/* NAVIGATION: Strict centering for collapsed view */}
